...
def GetData():
    ...
    request = requests.get(
        r"https://api.hh.ru/vacancies?text=c%23&search_field=name&order_by=publication_time&per_page=10&page=1&date_from=2022-12-21T00:00:00&date_to=2022-12-22T12:00:00"
    )
